...
export default function AccordContainer() {
  const accordItemsLeft = [
    {
      accordHeader: `What do I need to book a car on Turo?`,
      accordText: `To book a car on Turo, you must create a Turo account, be 18 years old or older in the US, 21 years old or older in the UK, 23 years old or older in Canada, have a valid driver’s license, and get approved to drive on Turo. When you’re booking your first trip, you’ll go through a quick approval process by entering your driver’s license and some other information. In most cases, you’ll get approved immediately, and you’ll be set for all future road trips, day trips, and business trips! `,
    },
    {
      accordHeader: `Do I need my own insurance?`,
      accordText: `No, you don’t need personal insurance coverage to book a car on Turo.
    ...
    {
      accordHeader: `What is the cancellation policy on Turo? `,
      accordText: `You can cancel and get a full refund up to 24 hours before your trip starts. If you book a trip with less than 24 hours’ notice, you have one hour after booking to cancel free of charge. If you cancel after the free cancellation period ends, you will be charged a small cancellation fee.
  ...
  const accordItemsRight = [
    {
      accordHeader: `What happens if I have an accident? `,
      accordText: ` If there’s an emergency or an issue with the car, call our emergency roadside assistance provider, available 24/7. We’ll make sure you’re safe, then help you get back on your way.`,
    },
    {
      accordHeader: `Can I get my car delivered to me? `,
      accordText: ` Yes, many hosts offer delivery to travel hubs like airports, train stations, and hotels, or to custom delivery locations. There are cars available on Turo at convenient locations near hundreds of airports. Skip the rental counter and have your car delivered for pickup and return at your hotel or vacation rental, or nearby location, to save time and hassle on your weekend getaway or family vacation. Some hosts offer free delivery, while others set their own delivery fee.`,
    },
    {
      accordHeader: `How do I get discounts when booking a car? `,
      accordText: `Many Turo hosts offer discounted prices for weekly and monthly trips, as well as “early bird” discounts for trips booked a week or more in advance. Get the best deals and lowest rates possible on everything from cars to SUVs by booking longer trips, at least a week in advance.*
    ...
    {
      accordHeader: `What are the cleaning and safety policies on Turo? `,
      accordText: `Under the enhanced cleaning policy, hosts are required to clean and disinfect their vehicles thoroughly before every trip, so you can feel safe and comfortable behind the wheel. Turo hosts have access to training materials on enhanced safety measures and cleaning practices to help prevent the spread of COVID-19 or other viruses. `,
    },
  ];
  ...
  return (
    ...
    <div className="accordContainer">
      ...
      <div className="accordContainer2">
        {accordItemsRight.map((item) => {
          return (
            <Accord
              accordHeader={item.accordHeader}
